"""
Django settings for learnfluid project.
...
SECRET_KEY = "django-insecure-dhxun!1puo!sx)_beez75zq!!uw7mn4&$(1wa+c=9*$$grm!^("
...
WSGI_APPLICATION = "learnfluid.wsgi.application"
